# Cocktail-archive
I built a cocktail database using **SQLite** which I'm populating to use it in a mobile or web app, which I'll use as a reference guide in the preperation of drinks, one of my hobbies.
...
* getting a first grasp on app developement
